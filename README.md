...
|---------------------|-----------------------|------------------------|-------------------------------------------------|-------------------------------------------------|---------------------------------|--------------------------------|
| CatBoost_10K | Градиентный бустинг    | Финансовые данные      | `iterations=10000, learning_rate=0.03, depth=6` | `MAE:4927.98, R2:0.668, MSE:43454511`                                   | Высокая точность, стабильность | Долгое обучение                |
| CatBoost_1K | Градиентный бустинг    | Финансовые данные      | `iterations=1000, learning_rate=0.1, depth=6`  | `MAE:2495.33, R2: 0.90, MSE:14359037.01`                                   | Быстрее обучается              | Меньше итераций — ниже точность |
| BaseLineAR  | Временные ряды         | Временные ряды        | `AutoReg(lags=[1,6,11,16]), ARIMA(5,1,2)`      | `R2: -2.78, MSE: 496007913, MAE: 17613`         | Простота, скорость обучения     | Низкая точность, чувствительность к шуму |
